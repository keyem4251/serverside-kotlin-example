...
class RentalService(
    ...
    fun startRental(bookId: Long, userId: Long) {
        ...
        val returnDaedLine = rentalDateTime.plusDays(RENTAL_TERM_DAYS)
        val rental = Rental(bookId, userId, rentalDateTime, returnDaedLine)
    ...
    fun endRental(bookId: Long, userId: Long) {
        ...
        // 貸し出し中のチェック
        if (!book.isRental) throw IllegalStateException("他のユーザーが貸し出し中の商品です userId: $userId bookId: $bookId")
